...
def quiz_generator(images,difficulty):
    ...
    prompt =f"""Generate 3 quizzes on the basis of given images and given {difficulty}.
    Make sure to add markdown to differentiate the option,give the correct answers after each quiz"""
